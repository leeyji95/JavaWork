...
public class WriteDTO {
	...
	// 클래스 필드명 = DB 필드명 = form 의 name명 (게시판의 어떤 컬럼인지를 식별하는데에 좋다)

	// 기본생성자, 매개변수 생성자, getter / setter

	public WriteDTO() {
		super();
		System.out.println("WriteDTO() 객체 생성"); // 언제 생성되는지 찍어보기 위한 확인 용도
	}
	...
	// 나중에 빈 객체로 만들어 지고, 나도 모르는 사이에 getter/ setter 막 호출된다. ... 
	public int getUid() {
	...
	public String toString() {
		return "WriteDTO] " + uid + " : " + subject + " : " + content + " : " + 
				name + " : " + viewCnt + " : " + regDate;
	}
