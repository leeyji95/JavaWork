...
// 	
primitive 는 자기 자신이 값을 가지고 있음
reference 값은 힙에, 자기자신은 값의 주소를 가리키고 있음.
just 참조하고 있는 것. --> 레퍼런싱
//
...
public class Array01Main { 
	...
	public static void main(String[] args) {
		...
		int korean3 = 77;
		// ...
		// 다량의 데이터를 위해서 매번 변수 작성하는 건... 사실상 불가.

		// 배열의 선언, 초기화
		int[] korean = new int[3]; // 인티저형 배열타입
		// int타입 배열 선언
		// 3개의 int 데이터를 담는 배열로 초기화

		korean[0] = 90; // 첫번째 배열원소에 90 대입, 인덱스 번호 0 ~ 2
		korean[1] = 80;
		korean[2] = 70;

		System.out.println("국어 0 : " + korean[0]);
		System.out.println("국어 0 : " + korean[1]);
		System.out.println("국어 0 : " + korean[2]);

		// korean[3] = 60; // 에러는 나지 않으나, Exception 발생
