...
public class PhonebookMain {
	...
	// 멤버변수
	private Scanner sc;
	private PhonebookManager pbCtrl; // CONTROLLER 객체    (인터페이스 phonebookController 상속받음) 
...
//  입력 끝 -----		
		// CONTROLLER 연결
		int result = pbCtrl.updateByUid(uid, name, phoneNum, memo); // 이 값을 정수값으로 결과 받고,
