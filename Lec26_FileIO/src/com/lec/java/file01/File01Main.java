...
// ~~Stream 이면 바이트 단위 입출력 ,   ~~~Reader, Writer 하면 문자단위 입출력

3) java.io.File : 파일 시스템의 파일정보를 얻기 위한 클래스  / 딕렉토리 생성, 파일의 정보 얻기 위함
	
4) java.io.Console : 콘솔로부터 문자을 입출력하기 위한 클래스(XXX) 
*/
...
public class File01Main {
	...
	public static void main(String[] args) {
		...
		Scanner sc = new Scanner(System.in);  // in 커서 -->  inputStream  표준 입력에 빨대 꽂은 애
		sc.close();
