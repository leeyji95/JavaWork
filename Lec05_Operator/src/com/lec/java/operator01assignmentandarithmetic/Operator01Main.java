package com.lec.java.operator01assignmentandarithmetic;
...
public class Operator01Main {
	...
	public static void main(String[] args) {
		...
		System.out.println("나머지 연산 결과: " + result3);  // 12.1 = 3.0 * 4 + 0.1
		
		
		// 두 변수 값 바꾸는 방법 (서로 교환하는 방법)
		int num3 = 100;
		int num4 = 200;
		int temp; // 임시변수
		...
		int num5;
		int num6;
		System.out.println("num5: " + (num5 = 100));  // 대입연산의 결과값이다... 
		
		// 그래서 이런게 가능함   대입연산자는 우측부터 실행. 
		num6 = num5 = 300;
