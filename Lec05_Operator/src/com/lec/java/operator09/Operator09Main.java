...
public class Operator09Main {
	...
	public static void main(String[] args) {
		...
		/* int 보다 같거나 작은 애들끼리의 산술 연산 결과 --> 무조건 int 타입이 된다. */
		...
		char ch3 = (char)(ch1 + ch2);  // 따라서 명시적 형변환 필요하다.
		...
		// int  이하끼리 연산결과 무조건 int 이기 떄문에 주의!
		long l2 = 27000000000L;
		System.out.println("l2 = " + l2);
		
		l2 = 3000 * 3000 * 3000;   // int 끼리의 곱이잖어.  int 의 범위를 넘을 수가 없음.
		System.out.println("l2 = " + l2);
		...
		int sum = 0;
		double d4 = 1.2;
		// sum = sum + d4;  --> int + double = double 
		sum += d4;  // 아니 이건 왜 돼?
		System.out.println(sum);
		
		// sum += d4 복합대입연산자는 
		// sum  = sum + d4 가 아니라...   내부적으로....
		// 요렇게 sum = (int)(sum + d4) 으로 동작함.
