package com.lec.java.exception05multicatchfinally;
...
public class Exception05Main {
	...
	public static void main(String[] args) {
		...
		// Exception 으로만 잡으면, 각각의 핸들링하기 어려워짐.  
		// 그래서 디테일하게 처리하고 싶은 부분만 핸들링 해주고, 
		// 나머지는 Exception 으로 처리해줘라~
...
// 3.			return;   
		...
		// finally 는 예외가 발생하든, 안하든 
		// return 해도 return 직전에 무조건
		// 설상 catch 절에 핸들링이 없어도 
		// 무.조.건. 수행됨!!!
