package com.lec.java.exception02trycatch;
...
public class Exception02Main {
	...
	public static void main(String[] args) {
		...
		try {
			// 수행블럭
			result = num1 / num2;  // 여기서 Exception 발생하면 아래 수행하지 않고 catch 문으로 넘어감.
			System.out.println("결과: " + result);
		} catch (ArithmeticException e) {  // 발생된 Exception 이 Arith~ 예외라면 이 캐치문에서 처리하겠다.
