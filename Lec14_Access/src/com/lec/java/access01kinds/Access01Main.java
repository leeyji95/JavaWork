package com.lec.java.access01kinds;
...
// 사용범위: private < (default) < protected < public (이 순서대로 외우기!!)
...
public class Access01Main {
	...
	public static void main(String[] args) {
		...
		Test01 t1 = new Test01();
		 ...
		 Test02 t2 = new Test02();  // 다른 패키지에 있는 것은 꼭 import 해야함. !!!
//			t2.privateNum = 10;
//			t2.defaultNum = 20;
//			t2.protectedNum = 40;   
//			t2.publicNum = 50;
